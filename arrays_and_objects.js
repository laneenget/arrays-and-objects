...
console.log(Object.values(cats_and_owners[1]));
// TODO Taylor Swift's cat is called 'Meredith'. Write code to add this data to the array.
cats_and_owners.push({name: "Taylor Swift", cat: "Meredith"});
// TODO write a loop to print each cat owner, and their cat's name, one per line. Use the forEach style.
cats_and_owners.forEach(function(value){
  console.log(value);
})
...
console.log(nobel_prize_winners_2017.prizes[3].laureates[0].surname);

// TODO print the ids of each of the Physics Nobel laureates. Your code should still work without modification if a laureate was added, or removed.
for (let i in nobel_prize_winners_2017.prizes[0].laureates){
  console.log(nobel_prize_winners_2017.prizes[0].laureates[i].id);
}
// TODO write code to print the names of all of the prize categories (So your output would start physics, chemistry, medicine... ).
for (let i in nobel_prize_winners_2017.prizes){
...
let laureates = 0;
for (let i in nobel_prize_winners_2017.prizes){
  nobel_prize_winners_2017.prizes[i].laureates.forEach(function(element){
    laureates++;
  })
}
